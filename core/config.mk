...
ifneq ($(CATALYST_BUILD),)
include vendor/catalyst/config/BoardConfigCatalyst.mk
endif
...
ifneq ($(CATALYST_BUILD),)
ifneq ($(wildcard device/catalyst/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/catalyst/sepolicy/common/sepolicy.mk)
endif
endif
